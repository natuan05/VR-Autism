...
## ✅ VẤN ĐỀ 1: Singleton Không Nhất Quán (HOÀN THÀNH)
...
## ✅ VẤN ĐỀ 2: Thiếu Namespace (HOÀN THÀNH)
...
## ✅ VẤN ĐỀ 3: Dead Code – Code Đã Comment-Out (HOÀN THÀNH)
...
## ⏳ VẤN ĐỀ 4: Magic Strings cho Firebase Path (Tạm hoãn - Chờ Build Kính VR)
...
## ✅ VẤN ĐỀ 7: Tách Data Classes Ra File Riêng (HOÀN THÀNH)
